...
- [上下文 Token 溢出解决方案](#上下文-token-溢出解决方案)
  - [目录](#目录)
  ...
  - [3. 实施步骤与资源需求](#3-实施步骤与资源需求)
    - [3.1 实施阶段划分](#31-实施阶段划分)
      - [阶段一：止血（1–2 天）](#阶段一止血12-天)
      - [阶段二：治标（1–2 周）](#阶段二治标12-周)
      - [阶段三：治本（3–6 周）](#阶段三治本36-周)
  ...
  - [8. 附录](#8-附录)
    - [8.1 关键参数推荐值汇总](#81-关键参数推荐值汇总)
    - [8.2 监控告警阈值](#82-监控告警阈值)
    - [8.3 术语表](#83-术语表)
...
文档维护建议：每次模型、工具 schema 或提示模板变更后，重新校准 Token 计数偏差与安全裕度；上线后以真实任务成功率和上下文质量，而不是单纯的“无溢出率”，评价方案效果。
