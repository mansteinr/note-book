...
- **2005 年 Samy 蠕虫**：MySpace 上传播的 XSS 蠕虫，24 小时感染 100 万用户
- **2014 年 Sony Pictures**：XSS 导致用户数据泄露
- **2019 年 Steam**：商店页面 XSS 漏洞可窃取用户账户
...
**定义**：恶意代码完全在**客户端 JavaScript** 处理，不经过服务器，通过修改 DOM 树触发。
