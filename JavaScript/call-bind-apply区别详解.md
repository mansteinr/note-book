...
> 本文档深入解析 JavaScript 中 `Function.prototype` 上的三个方法：`call`、`bind` 和 `apply`，涵盖它们的基本定义、语法结构、参数传递方式、执行时机、返回值差异，以及各自的适用场景和最佳实践。
...
> **文档版本**：v1.0  
> **适用版本**：JavaScript（ES5+、ES6+）  
> **最后更新**：2026-08  
> **参考来源**：MDN Web Docs、ECMAScript 规范